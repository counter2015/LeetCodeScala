...
import algorithms.medium.tree.ConnectNodes2.{connect => solve}
import algorithms.struct.NodeTest
import org.scalatest.funsuite.AnyFunSuite
import org.scalatest.matchers.should.Matchers

class ConnectNodes2Test extends AnyFunSuite with Matchers with NodeTest {

  test("test0: sample input") {
    val arr: Array[Either[String, Int]] = Array(1, 2, 3, 4, 5, "null", 7)
