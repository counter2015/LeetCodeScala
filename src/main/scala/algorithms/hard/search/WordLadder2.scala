...
object WordLadder2 {
  ...
  /** RunTime Info: 1160 ms, 61.5MB
    ...
    *   the word list
    * @return
    *   the shortest transform path from begin word to end word
    */
  def findLadders(beginWord: String, endWord: String, wordList: List[String]): List[List[String]] = {
    ...
    val prevMap: scala.collection.mutable.Map[String, List[String]] =
  ...
  def bfs(
    ...
    endWord: String,
    wordSet: Set[String],
    prevMap: scala.collection.mutable.Map[String, List[String]],
    distance: scala.collection.mutable.Map[String, Int]
  ): Unit = {
  ...
  def generatePaths(
    prevMap: Map[String, List[String]],
    beginWord: String,
    endWord: String,
